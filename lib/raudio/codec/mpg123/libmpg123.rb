...
module RAudio
  class Codec
	...
	'MPG123_RVA_MAX'   => 2
      ...
      extern('int mpg123_param(mpg123_handle *mh, enum mpg123_parms, long, double)')
      ...
      extern('int mpg123_getparam(mpg123_handle *mh, enum mpg123_parms, long *val, double *fval)')
	...
	'MPG123_FEATURE_PARSE_ICY'         => 12
      ...
      extern('int mpg123_feature(enum mpg123_feature_set)')
      ...
      extern('const char* mpg123_plain_strerror(int)')
      ...
      extern('const char* mpg123_strerror(mpg123_handle *mh)')

      # /** Return the plain errcode intead of a string. */
      # EXPORT int mpg123_errcode(mpg123_handle *mh);
      extern('int mpg123_errcode(mpg123_handle *mh)')
      ...
      extern('const char **mpg123_decoders()')
      ...
      extern('const char **mpg123_supported_decoders()')

      # /** Set the chosen decoder to 'decoder_name' */
      # EXPORT int mpg123_decoder(mpg123_handle *mh, const char* decoder_name);
      extern('int mpg123_decoder(mpg123_handle *mh, const char* decoder_name)')
      ...
      extern('const char* mpg123_current_decoder(mpg123_handle *mh)')
      ...
      Mpg123_Enc_Enum = {
        ...
        'MPG123_ENC_SIGNED_16'   => (0x040|0x080|0x10),
        'MPG123_ENC_UNSIGNED_16' => (0x040|0x20),
        'MPG123_ENC_UNSIGNED_8'  => 0x01,
        'MPG123_ENC_SIGNED_8'    => (0x080|0x02),
        'MPG123_ENC_ULAW_8'      => 0x04,
        'MPG123_ENC_ALAW_8'      => 0x08,
        'MPG123_ENC_SIGNED_32'   => (0x100|0x080|0x1000),
        'MPG123_ENC_UNSIGNED_32' => (0x100|0x2000),
        'MPG123_ENC_FLOAT_32'    => 0x200,
        'MPG123_ENC_FLOAT_64'    => 0x400,
        'MPG123_ENC_ANY' => ( (0x040|0x080|0x10) | (0x040|0x20) | 0x01 |
                              (0x080|0x02) | 0x04 | 0x08 | (0x100|0x080|0x1000) |
                              (0x100|0x2000) | 0x200 | 0x400 )
      }
	...
	'MPG123_STEREO' => 2,
      ...
      extern('void mpg123_rates(const long **list, size_t *number)')
      ...
      extern('void mpg123_encodings(const int **list, size_t *number)')
      ...
      extern('int mpg123_format_none(mpg123_handle *mh)')
      ...
      extern('int mpg123_format_all(mpg123_handle *mh)')
      ...
      extern('int mpg123_format(mpg123_handle *mh, long, int, int)')
      ...
      extern('int mpg123_format_support(mpg123_handle *mh, long, int)')
      ...
      extern('int mpg123_open_fd(mpg123_handle *mh, int)')
      ...
      extern('int mpg123_open_handle(mpg123_handle *mh, void *iohandle)')
      ...
      extern('int mpg123_read(mpg123_handle *mh, unsigned char *outmemory, size_t, size_t *done)')
      ...
      extern('int mpg123_feed(mpg123_handle *mh, const unsigned char *in, size_t)')
      ...
      extern('int mpg123_decode(mpg123_handle *mh, const unsigned char *inmemory, size_t, unsigned char *outmemory, size_t, size_t *done)')
      ...
      extern('int mpg123_decode_frame(mpg123_handle *mh, off_t *num, unsigned char **audio, size_t *bytes)')
      ...
      extern('int mpg123_framebyframe_decode(mpg123_handle *mh, off_t *num, unsigned char **audio, size_t *bytes)')
      ...
      extern('int mpg123_framebyframe_next(mpg123_handle *mh)')
      ...
      extern('off_t mpg123_seek(mpg123_handle *mh, off_t, int)')
      ...
      extern('off_t mpg123_feedseek(mpg123_handle *mh, off_t, int, off_t *input_offset)')

      # /** Seek to a desired MPEG frame index.
      #  *  Set whence to SEEK_SET, SEEK_CUR or SEEK_END.
      #  *  \return The resulting offset >= 0 or error/message code */
      # EXPORT off_t mpg123_seek_frame(mpg123_handle *mh, off_t frameoff, int whence);
      extern('off_t mpg123_seek_frame(mpg123_handle *mh, off_t, int)')
      ...
      extern('off_t mpg123_timeframe(mpg123_handle *mh, double)')
      ...
      extern('int mpg123_index(mpg123_handle *mh, off_t **offsets, off_t *step, size_t *fill)')
      ...
      extern('int mpg123_set_index(mpg123_handle *mh, off_t *offsets, off_t, size_t)')
      ...
      extern('int mpg123_position( mpg123_handle *mh, off_t, off_t, off_t *current_frame, off_t *frames_left, double *current_seconds, double *seconds_left)')
	...
	'MPG123_LR'    => 0x3
      ...
      extern('int mpg123_eq(mpg123_handle *mh, enum mpg123_channels, int, double)')
      ...
      extern('double mpg123_geteq(mpg123_handle *mh, enum mpg123_channels, int)')

      # /** Reset the 32 Band Audio Equalizer settings to flat */
      # EXPORT int mpg123_reset_eq(mpg123_handle *mh);
      extern('int mpg123_reset_eq(mpg123_handle *mh)')
      ...
      extern('int mpg123_volume(mpg123_handle *mh, double)')

      # /** Adjust output volume including the RVA setting by chosen amount */
      # EXPORT int mpg123_volume_change(mpg123_handle *mh, double change);
      extern('int mpg123_volume_change(mpg123_handle *mh, double)')
      ...
      extern('int mpg123_getvolume(mpg123_handle *mh, double *base, double *really, double *rva_db)')
	...
	'MPG123_ORIGINAL'  => 0x8
      ...
      # };
      Mpg123_FrameInfo =
        struct(['enum mpg123_version version',
                'int layer',
                'long rate',
      ...
      extern('int mpg123_info(mpg123_handle *mh, struct mpg123_frameinfo *mi)')
      ...
      extern('size_t mpg123_safe_buffer()')
      ...
      extern('int mpg123_scan(mpg123_handle *mh)')
      ...
      extern('off_t mpg123_length(mpg123_handle *mh)')
      ...
      extern('int mpg123_set_filesize(mpg123_handle *mh, off_t)')

      # /** Returns the time (seconds) per frame; <0 is error. */
      # EXPORT double mpg123_tpf(mpg123_handle *mh);
      extern('double mpg123_tpf(mpg123_handle *mh)')

      # /** Get and reset the clip count. */
      # EXPORT long mpg123_clip(mpg123_handle *mh);
      extern('long mpg123_clip(mpg123_handle *mh)')
      ...
      extern('int mpg123_getstate(mpg123_handle *mh, enum mpg123_state, long *val, double *fval)')
      ...
      extern('int  mpg123_grow_string(mpg123_string* sb, size_t)')
      ...
      extern('int  mpg123_copy_string(mpg123_string* from, mpg123_string* to)')

      # /** Append a C-String to an mpg123_string
      #  *  \return 0 on error, 1 on success */
      # EXPORT int  mpg123_add_string(mpg123_string* sb, const char* stuff);
      extern('int  mpg123_add_string(mpg123_string* sb, const char* stuff)')
      ...
      extern('int  mpg123_add_substring(mpg123_string *sb, const char *stuff, size_t, size_t)')

      # /** Set the conents of a mpg123_string to a C-string
      #  *  \return 0 on error, 1 on success */
      # EXPORT int  mpg123_set_string(mpg123_string* sb, const char* stuff);
      extern('int  mpg123_set_string(mpg123_string* sb, const char* stuff)')
      ...
      extern('int  mpg123_set_substring(mpg123_string *sb, const char *stuff, size_t, size_t)')
	...
	'mpg123_id3_enc_max'  => 3
      ...
      extern('enum mpg123_text_encoding mpg123_enc_from_id3(unsigned char)')
      ...
      extern('int mpg123_store_utf8(mpg123_string *sb, enum mpg123_text_encoding, const unsigned char *source, size_t)')
      ...
      extern('int mpg123_meta_check(mpg123_handle *mh)')
      ...
      extern('int mpg123_id3(mpg123_handle *mh, mpg123_id3v1 **v1, mpg123_id3v2 **v2)')
      ...
      extern('int mpg123_icy(mpg123_handle *mh, char **icy_meta)')
      ...
      extern('char* mpg123_icy2utf8(const char* icy_text)')
      ...
      extern('int mpg123_fmt(mpg123_pars *mh, long, int, int)')
...
# /** Check to see if a specific format at a specific rate is supported 
        ...
        extern('int mpg123_fmt_support(mpg123_pars *mh,   long, int)')
      ...
      extern('int mpg123_par(mpg123_pars *mp, enum mpg123_parms, long, double)')
      ...
      extern('int mpg123_getpar(mpg123_pars *mp, enum mpg123_parms, long *val, double *fval)')
      ...
      extern('int mpg123_replace_buffer(mpg123_handle *mh, unsigned char *data, size_t)')
      ...
      R_Read  = bind('ssize_t * r_read(int, void *, size_t)', :temp)
      R_Lseek = bind('off_t   * r_lseek(int, off_t, int)', :temp)
      ...
      extern('int mpg123_replace_reader(mpg123_handle *mh, ssize_t *r_read, off_t *r_lseek)')
      ...
      extern('int mpg123_replace_reader_handle(mpg123_handle *mh, ssize_t *r_read, off_t *r_lseek)')
    end
  end
end
